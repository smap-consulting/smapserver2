...
public class QuestionInfo {
	 ...
	 */
	public QuestionInfo(int surveyId, int questionId, Connection connection, boolean isGeom, 
			String lang, String urlprefix) throws SQLException {	
		this.isGeom = isGeom;
		...
		String sql = "SELECT f.table_name, f.f_id, f.parentform, q.qname, q.qtype, t.value, q.calculate" + 
				" FROM survey s " +
				" INNER JOIN form f " +
				" ON s.s_id = f.s_id" +
		...
		if(resultSet.next()) {
			...
			log.info("Table:"  + tableName + ":" + fId + ":" + parentFId + ":" + qName + ":" + qType + " : " + qLabel);
