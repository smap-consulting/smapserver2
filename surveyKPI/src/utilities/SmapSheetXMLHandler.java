...
public class SmapSheetXMLHandler extends DefaultHandler {
	...
	public SmapSheetXMLHandler(
			...
			boolean formulasNotResults,
			SimpleDateFormat sdf) {
		this(styles, null, strings, sheetContentsHandler, dataFormatter, formulasNotResults, sdf);
	}
	...
	public interface SheetContentsHandler {
		...
		void cell(String cellReference, String formattedValue, XSSFComment comment, 
				xssfDataType nextDataType, String formatString);
