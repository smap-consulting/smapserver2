...
public class Summary extends Application {
	...
	public Response getEndPoints(@Context HttpServletRequest request) { 
		...
		SummaryEndPoint tasks = new SummaryEndPoint(request, "tasks", "Summary of tasks");
		endPoints.add(tasks);
	...
	public Response getTasks(@Context HttpServletRequest request,
		...
		try {
			...
			res.add("2016-4", "pending", 2);
			res.add("2016-4", "complete", 8);
			res.add("2016-5", "pending", 6);
			res.add("2016-4", "complete", 3);
